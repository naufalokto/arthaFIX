...
<body class="bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    @if(auth()->check())
                        <a href="/customer/dashboard" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
    ...
    <div class="auth-modal bg-white rounded-lg shadow-xl p-8" id="auth-modal">
        <div class="text-center">
            ...
            <p class="text-gray-500 mb-6">Please login or create an account to add items to cart and make purchases</p>
                ...
                <div class="product-card bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <span class="text-sm ${product.quantity > 10 ? 'text-green-600' : 'text-orange-600'}">
                                Stock: ${product.quantity}
                            </span>
                        </div>
                        <button onclick="handleAddToCart(${product.product_id})" 
                                class="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 ${product.quantity === 0 ? 'opacity-50 cursor-not-allowed' : ''}"
